package com.syd.classdiary.event;
...
import com.syd.classdiary.service.MessageService;
...
//    }
    ...
    public void handleShareMessage(ConsumerRecord record) {
        ...
        try {
            //在执行这个方法把命令传给本地电脑的执行过程中（不一定执行完），就会执行下面一行的日志代码。所以需要定时器来监控此处是否正确返回。
        ...
        // 每隔半秒看一下，你生没生成，直到有一次我发现你生成了，然后我传。
