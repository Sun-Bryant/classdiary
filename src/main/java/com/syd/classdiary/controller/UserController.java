...
import com.syd.classdiary.service.*;
...
public class UserController implements CommunityConstant {
    ...
    @Value("${classdiary.path.upload}")
    private String uploadPath;

    @Value("${classdiary.path.domain}")
...
//    }
    ...
    public String uploadHeader(MultipartFile headerImage, Model model) {
        ...
        //更新当前用户的头像的路径（Web路径）
        // http://localhost:8080/classdiary/user/header/xxx.png
    ...
    // 废弃
    // http://localhost:8080/classdiary/user/header/c31eb7949974401fa4e2aaa41b4b192b.jpg
